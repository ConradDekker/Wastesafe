    ...
    <div class="container flex-footer">
      <div class="f-item logo"><a href="<?php echo home_url(); ?>"><img src="<?php bloginfo('template_url'); ?>/img/logo-footer.png" width="495px" class="footerlogo" alt=""></a>
        ...
        <div class="f-item phone-assoc">
          <div class="social">
              <a href="https://www.facebook.com/WasteSafe-131634114374856/" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/facebookicon.png" width="45px" alt=""></a>
              <a href="https://twitter.com/waste_safe" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/twittericon.png" width="45px" alt=""></a>
              <a href="https://plus.google.com/113711225107103723570" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/googleicon.png" width="45px" alt=""></a>
              <a href="https://www.linkedin.com/company/wastesafe/" target="_blank"><img src="<?php bloginfo('template_url'); ?>/img/linkedinicon.png" width="45px" alt=""></a>
          </div>
          <div class="phone">
